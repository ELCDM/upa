  ...
  <div class="contactocontent cotizadorcont w-clearfix">
    ...
    <div class="max960 w-clearfix">
      ...
      <div class="listadereque">
        <div class="text-block-13">Ingrese sus datos personales para utilizar el cotizador.</div>
        <div class="text-block-13">Ingrese todos los datos que le solicita el cotizador.</div>
        <div class="text-block-13">Presione el botón "COTIZAR" para que despliegue la tabla con el cálculo requerido.</div>
      ...
      <div class="elcotizador">
        <div class="contentform demascampos w-clearfix">
          <h2 class="titformcot"> Ingresa tus datos para utilizar el cotizador</h2>
          <form id="utilizarcot" name="utilizarcot" method="post">
          <div class="uncamp w-clearfix">
            <label class="labcot" for="monto-solicitado">Nombre Completo</label>
            <input class="inputcoti w-input val" id="nombre_cot" maxlength="256" name="nombre" placeholder="" type="text" required="required" alert="false">
          </div>
          <div class="uncamp w-clearfix">
            <label class="labcot" for="plazo-en-meses">Correo electrónico</label>
            <input class="inputcoti w-input val" id="correo_cot" maxlength="256" name="correo" required="required" type="email" alert="false">
          </div>
          <div id="filaingresos" class="uncamp w-clearfix">
            <label class="labcot" for="ingresos-mensuales">Número de teléfono</label>
            <input class="inputcoti inputingas w-input val" id="numero_cot" maxlength="" ="256" name="telefono" required="required" type="number">
          </div>
          <!--<div class="captcha">
            <div id="captcha" class="g-recaptcha val" data-sitekey="6LfuISMUAAAAAH3l2nAFcICrj72fFZvh-tuBjwwI" type="captcha">
            </div>  
          </div>-->
          <input type="hidden" name="cotizar" value="true">
          <input type="button" id="utilizarcotbot" class="imputut cotizarr val" value="Utilzar Cotizador">
          </form>
        </div>
      </div>
      <div class="elcotizador w-clearfix cotz">
